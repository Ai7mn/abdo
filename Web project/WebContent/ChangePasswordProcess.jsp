...
<title>Changing password process...</title>
</head>
<body>
<p>
    	...
    	if (login){
    		try{
    			...
    			PreparedStatement stmt = connection.prepareStatement("update students set password= (?) where matric=?");
    			stmt.setString(1 , request.getParameter("newpass"));
    			stmt.setString(2 , request.getParameter("username"));
    			int row = stmt.executeUpdate();
    			
    			connection.commit();
    			out.println(row +"Password was changed ");
